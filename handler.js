...
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 『𝑺𝑈𝑃𝛩𝑅﹝🍉﹞𝑅𝐼𝑇𝐴-𝐵𝛩𝑇』 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 『𝑺𝑈𝑃𝛩𝑅﹝🍉﹞𝑅𝐼𝑇𝐴-𝐵𝛩𝑇』 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 『𝑺𝑈𝑃𝛩𝑅﹝🍉﹞𝑅𝐼𝑇𝐴-𝐵𝛩𝑇』 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + '『𝑺𝑈𝑃𝛩𝑅﹝🍉﹞𝑅𝐼𝑇𝐴-𝐵𝛩𝑇』')  
break
}}} catch (e) {
console.error(e)
} finally {
...
if (db.data.chats[m.chat].reaction && m.text.match(/(مروان|المطور|هلا|مرحبا|كيفك|اخبارك|احبك|اكرهم|تست|ليش|لا|اه|212657035661|『𝑅𝐼𝑇𝐴﹝🍇﹞𝐵𝛩𝑇』)/gi)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '『𝑺𝑈𝑃𝛩𝑅﹝🍉﹞𝑅𝐼𝑇𝐴-𝐵𝛩𝑇』') :
